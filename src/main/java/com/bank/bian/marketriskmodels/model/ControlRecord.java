package com.bank.bian.marketriskmodels.model;
...
/**
 * The BIAN control record for this service domain: "Market Risk Model Development Project".
 *
 ...
 * to its asset type (Market Risk Model). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Market Risk Model Development Project";
